...
HD_PWD='C:/Users/heman/Encoder/Encoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Rate_Coding.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Rate_Coding.tcl
