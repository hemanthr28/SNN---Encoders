...
HD_PWD='C:/Users/heman/Encoder/Encoder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Rate_Coding.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Rate_Coding.tcl -notrace
